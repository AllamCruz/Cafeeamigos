    ...
    <div className="min-h-screen bg-[#fcf8f3]">
      ...
      <div className="bg-[#532b1b] text-amber-50 p-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-serif">Sistema de Garçons</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center py-16">
          ...
          <h2 className="text-2xl font-serif text-[#532b1b] mb-4">Interface do Garçom</h2>
          <p className="text-gray-600 mb-8 max-w-md mx-auto">
            Esta é a interface dedicada aos garçons do estabelecimento.
          </p>
